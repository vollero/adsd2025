...
PROCESS_ID = 0  # Indice nel vettore orologio (0-based)
NUM_PROCESSES = 3
...
def send_message(recipient, message):
    global VECTOR_CLOCK
    VECTOR_CLOCK[PROCESS_ID] += 1
    timestamp = list(VECTOR_CLOCK)  # Invia una copia del vettore
...
def receive_message():
    ...
    sender_id = data['sender_id'] - 1  # Converti in indice 0-based
